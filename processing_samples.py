...
stack_samp = samples[burn_in:, [0,1,3]]
...
#fig = corner.corner(stack_samp, labels = ['$\\rho_0$', '$M_{BH}$', '$\\Psi$'], quantiles = [0.5])
#fig = corner.corner(stack_samp, labels = ['$\\rho_0$', '$r_K$', '$M_{BH}$'], quantiles = [0.5])
fig = corner.corner(stack_samp, labels = ['$\\rho_0$', '$r_K$', '$\\Psi$'], quantiles = [0.5])
